...
function Toggle(props) {
    ...
    const reset1=(e)=>{
        ...
        const rows = setRows(reset.result)
        const cols = setCols(reset.columns)
        // // {resettable(data)}
        // fulldata(e)
        console.log("reset",reset)
    }
    ...
    // const download=(e) =>{
    //     var csvBuilder =new CsvBuilder("filename.csv").setColumns(data.columns).addRows(data.result).exportFile();
    // }
